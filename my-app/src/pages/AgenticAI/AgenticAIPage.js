...
import {
  ...
  AgentProcessIllustration,
  AgentFaqIllustration
} from "./illustrations/AgenticAIIllustrations";

import agenticAIData from "./agenticAI.data";
...
export default function AgenticAIPage() {
  ...
  return (
    <main
      className="service-page agentic-ai-service-page"
      data-service="agentic-ai"
    >
      <Cursor />
