...
import {
  BusinessAutomationWorkflowIllustration,
  BusinessAutomationControlIllustration,
  BusinessAutomationProcessIllustration,
  BusinessAutomationFaqIllustration
} from "./illustrations/BusinessAutomationIllustrations";

import businessAutomationData from "./businessAutomation.data";
...
export default function BusinessAutomationPage() {
  ...
  return (
    <main
      className="service-page business-automation-service-page"
      data-service="business-automation"
    >
      <Cursor />
      ...
      <ServiceSplitSection
        sectionId="business-automation-intro"
        title={intro.title}
      ...
      <ServiceSplitSection
        sectionId="business-automation-why"
