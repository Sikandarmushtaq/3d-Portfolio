...
import {
  EcommerceStorefrontIllustration,
  EcommerceMarketplaceIllustration,
  EcommerceProcessIllustration,
  EcommerceFaqIllustration
} from "./illustrations/EcommerceMarketplaceIllustrations";

import ecommerceMarketplaceData from "./ecommerceMarketplace.data";

import "../../Components/ServicePage/ServicePage.css";

export default function EcommerceMarketplacePage() {
  useServicePageAnimations(
    ".ecommerce-marketplace-service-page"
  );
  ...
  const {
    ...
    packages,
    faq
  } = ecommerceMarketplaceData;

  return (
    <main
      className="service-page ecommerce-marketplace-service-page"
      data-service="ecommerce-marketplace"
    >
      <Cursor />
      ...
      <ServiceSplitSection
        sectionId="ecommerce-marketplace-intro"
        title={intro.title}
      ...
      <ServiceSplitSection
        sectionId="ecommerce-marketplace-why"
