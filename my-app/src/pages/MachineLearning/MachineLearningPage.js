...
import {
  MachineLearningDataIllustration,
  MachineLearningIntelligenceIllustration,
  MachineLearningProcessIllustration,
  MachineLearningFaqIllustration
} from "./illustrations/MachineLearningIllustrations";

import machineLearningData from "./machineLearning.data";

import "../../Components/ServicePage/ServicePage.css";

export default function MachineLearningPage() {
  useServicePageAnimations(
    ".machine-learning-service-page"
  );
  ...
  return (
    <main
      className="service-page machine-learning-service-page"
    ...
    >
      ...
      <ServiceSplitSection
        sectionId="machine-learning-intro"
        title={intro.title}
      ...
      <ServiceSplitSection
        sectionId="machine-learning-why"
