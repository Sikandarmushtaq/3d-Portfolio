...
import {
  FintechPlatformIllustration,
  FintechOperationsIllustration,
  FintechProcessIllustration,
  FintechFaqIllustration
} from "./illustrations/FintechIllustrations";

import fintechSolutionsData from "./fintechSolutions.data";

import "../../Components/ServicePage/ServicePage.css";

export default function FintechSolutionsPage() {
  useServicePageAnimations(
    ".fintech-solutions-service-page"
  );
  ...
  const {
    ...
    packages,
    faq
  } = fintechSolutionsData;

  return (
    <main
      className="service-page fintech-solutions-service-page"
      data-service="fintech-solutions"
    >
      <Cursor />
      ...
      <ServiceSplitSection
        sectionId="fintech-solutions-intro"
        title={intro.title}
      ...
      <ServiceSplitSection
        sectionId="fintech-solutions-why"
