...
import {
  RemarketingCampaignsIllustration,
  RemarketingCampaignsWhyIllustration,
  RemarketingCampaignsProcessIllustration,
  RemarketingCampaignsFaqIllustration
} from "./illustrations/RemarketingCampaignsIllustrations";

import remarketingData from "./remarketingCampaigns.data.js";

import "../../Components/ServicePage/ServicePage.css";

export default function RemarketingCampaignsPage() {
  useServicePageAnimations(".remarketing-service-page");
  ...
  return (
    <main
      className="service-page remarketing-service-page"
      data-service="remarketing"
    >
      <Cursor />
      <Navbar />
